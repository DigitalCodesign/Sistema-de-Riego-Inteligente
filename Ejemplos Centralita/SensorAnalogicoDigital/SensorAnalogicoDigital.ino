/**
 * SensorAnalogDigital.ino - Ejemplo de uso de sensores de señales
 * analógicas y digitales con la Centralita.
 * 
...
void loop() {
    ...
    const int medidaDigital = digitalRead(pinDigital);
    const int medidaAnalog = analogRead(pinAnalog);

    Serial.print("Lectura digital: ");
    Serial.println(medidaDigital);
